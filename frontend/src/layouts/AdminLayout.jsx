...
const AdminLayout = () => {
  ...
  const drawer = (
    <div className="flex h-full flex-col bg-white dark:bg-dark-200">
      <div className="p-6">
        <Typography variant="h5" className="gradient-text font-heading font-bold">
          Admin Panel
        </Typography>
      </div>
      <Divider />
      ...
      <Box className="p-4">
        <Box
          ...
          alignItems="center"
          gap={2}
          className="rounded-lg bg-gray-50 p-3 dark:bg-dark-300"
        >
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap sx={{ flexGrow: 1 }}>
            {ADMIN_NAV_LINKS.find((link) => link.path === location.pathname)?.label ||
              'Admin Panel'}
          </Typography>
